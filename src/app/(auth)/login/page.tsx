        ...
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription className="mt-1">
              Home Interior Project Management
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="text-center text-sm text-muted-foreground">
            Track expenses, plan timelines, and manage your Vario Homes B1502 interiors — all in one place.
          </div>
          ...
          <p className="text-center text-xs text-muted-foreground">
            Accessible to all family members with a shared project.
          </p>
        </CardContent>
      </Card>
    </div>
